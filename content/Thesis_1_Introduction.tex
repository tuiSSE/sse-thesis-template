...
\begin{enumerate}[\bfseries (A) {-}]
  \item Das Kapitel \ref{sec:haupt} trägt den Titel \nameref{sec:haupt}\footnote{Die Nutzung von Nameref ist in vielen Situationen nützlich} und beginnt auf Seite \pageref{sec:haupt} 
